...
namespace Tenduke.EntitlementClient.Util
{
    /// <summary>
    ...
    /// </summary>
    public class EntClientAuthorizationSerializer
    {
        #region Properties

        /// <summary>
        /// The <see cref="EntClient"/> for which <see cref="AuthorizationInfo"/> is serialized or deserialized.
        /// </summary>
        public EntClient EntClient { get; set; }
        ...
        private EntClient AssertEntClient()
        {
            if (EntClient == null)
            {
